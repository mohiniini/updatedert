...
@Component({
  selector: 'app-mog-details-admin',
  templateUrl: './mog-details-admin.component.html',
  styleUrls: ['./mog-details-admin.component.css']
})
export class MogDetailsAdminComponent implements OnInit {
  ...
  decline(){
    ...
    this.http.updateRequest(this.request).subscribe(data => {
      ...
      this.router.navigate(["../../movement-goods"], {
