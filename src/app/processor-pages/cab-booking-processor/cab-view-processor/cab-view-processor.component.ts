...
@Component({
  selector: 'app-cab-view-processor',
  templateUrl: './cab-view-processor.component.html',
  styleUrls: ['./cab-view-processor.component.css']
})
export class CabViewProcessorComponent implements OnInit  {
