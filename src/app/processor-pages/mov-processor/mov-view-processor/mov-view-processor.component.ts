...
@Component({
  selector: 'app-mov-view-processor',
  templateUrl: './mov-view-processor.component.html',
  styleUrls: ['./mov-view-processor.component.css']
})
export class MovViewProcessorComponent implements OnInit {
  ...
  sendVoucher(){
    let postdata={
      ...
      "message": "movement of vehicle ticket",
